$(function() {
	...
	function ajaxQuery(value){
		console.log("https://www.googleapis.com/customsearch/v1?q="+encodeURIComponent(value)+"&key=AIzaSyDQq5I1_jJG2eKE78NEUM8GCBRwgXRW0F4&cx=000283222127530457480:fcqttmqm5o0&callback=?");
			$.ajax({
